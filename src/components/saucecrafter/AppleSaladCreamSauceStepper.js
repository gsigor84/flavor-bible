...
const baseSauce = {
  "Apple sauce": 80,
  "Salad cream": 50,
  "Mustard (e.g., English)": 20,
  "Cooking vinegar (e.g., malt)": 10,
  "Sugar": 5,
};

export default function AppleSaladCreamSauceStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Whisk together 80 g apple sauce, 50 g salad cream, 20 g mustard, 10 g cooking vinegar, and 5 g sugar in a bowl until fully combined. No cooking required.</p>
          <p><strong>How to Use:</strong> Serve as a dressing for coleslaw or potato salad, or use as a spread for pork sandwiches.</p>
          <p><strong>Flavor Profile:</strong> Sweet, creamy, tangy, with a mustard kick.</p>

          <div className="flex justify-between pt-4 border-t">
            <button onClick={() => setStep(1)} className="px-4 py-2 bg-gray-100 rounded hover:bg-gray-200 text-sm">Back</button>
            <button onClick={resetSauce} className="px-4 py-2 bg-gray-800 text-white rounded hover:bg-gray-700 text-sm">Reset</button>
          </div>
        </div>
      )}
    </div>
