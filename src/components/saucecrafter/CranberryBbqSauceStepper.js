...
export default function CranberryBbqSauceStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Heat and stir all ingredients for 5–7 minutes until thickened.</p>
          <p><strong>How to Use:</strong> Use as a glaze for chicken or pork, or as a dipping sauce.</p>
          <p><strong>Flavor Profile:</strong> Sweet, tangy, and savory with a hint of spice.</p>
