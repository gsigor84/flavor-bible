...
export default function MexicanArrozRojoBlend() {
  ...
  return (
    <div className="p-2 max-w-md mx-auto bg-white space-y-6">
      <div className="flex items-center justify-start">
        <h2 className="text-2xl font-bold">Mexican Arroz Rojo Blend (Grams)</h2>
      </div>

      <div className="space-y-4">
        {Object.entries(blend).map(([ingredient, grams]) => (
          <div key={ingredient} className="flex items-center justify-between gap-2">
            <label className="w-32 capitalize text-gray-700">{ingredient}:</label>
