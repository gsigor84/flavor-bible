...
export default function SpicyMarinadeStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Whisk together all ingredients until well combined.</p>
          <p><strong>How to Use:</strong> Ideal for chicken or shrimp. Great for grilling or stir-frying.</p>
