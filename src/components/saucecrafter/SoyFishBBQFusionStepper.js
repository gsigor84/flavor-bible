...
const baseSauce = {
  "BBQ sauce (sweet variety)": 70,
  "Soy sauce": 30,
  "Fish sauce": 10,
  "Cooking vinegar (e.g., white vinegar)": 15,
  "Sugar": 10,
};

export default function SoyFishBBQFusionStepper() {
  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      <div className="flex justify-between text-sm font-medium text-gray-600">
        <div
          className={`flex-1 text-center py-2 border-b-2 ${step === 1
        ...
        <div
          className={`flex-1 text-center py-2 border-b-2 ${step === 2
              ? "border-black font-bold text-black"
              : "border-gray-300"
            }`}
        >
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p>
            <strong>How to Make:</strong> In a small pan, combine all ingredients. Simmer over medium heat for 5–7 minutes until slightly reduced.
          </p>
          <p>
            <strong>How to Use:</strong> Use as a marinade for grilled fish or shrimp, or as a dipping sauce for dumplings or fried snacks.
          </p>
          <p>
            <strong>Flavor Profile:</strong> Sweet, salty, umami-rich, with a smoky edge.
          </p>
