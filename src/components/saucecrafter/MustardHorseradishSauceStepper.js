...
const baseSauce = {
  "Mustard": 50,
  "Horseradish sauce": 30,
  "Mayonnaise": 20,
  "Cooking vinegar": 10,
  "Salt": 1,
};

export default function MustardHorseradishSauceStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Whisk all ingredients together in a bowl until smooth.</p>
          <p><strong>How to Use:</strong> Use as a spread for sandwiches or as a dip for pretzels.</p>
          <p><strong>Flavor Profile:</strong> Sharp, tangy, creamy with horseradish heat.</p>
