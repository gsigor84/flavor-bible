...
export default function MayoPestoMarinadeStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Use:</strong> Ideal for chicken breast or fish fillets. Grill or bake.</p>
          <p><strong>Marination Time:</strong> 30 min–1 hour.</p>
