...
export default function CitrusSoyMarinadeStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Whisk all ingredients until combined.</p>
          <p><strong>How to Use:</strong> Perfect for fish, chicken, or pork. Cook as desired.</p>
          <p><strong>Marination Time:</strong> 30 minutes to 2 hours.</p>
