...
export default function HerbaceousMarinadeStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Mix all ingredients together until combined.</p>
          <p><strong>How to Use:</strong> Great for chicken or fish. Ideal for grilling or baking.</p>
          <p><strong>Marination Time:</strong> 30 min to 1 hour.</p>
