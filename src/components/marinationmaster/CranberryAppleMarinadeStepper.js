...
export default function CranberryAppleMarinadeStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Mix all ingredients until smooth.</p>
          <p><strong>How to Use:</strong> Perfect for pork loin or chicken. Roast or grill.</p>
          <p><strong>Marination Time:</strong> 2–4 hours.</p>
