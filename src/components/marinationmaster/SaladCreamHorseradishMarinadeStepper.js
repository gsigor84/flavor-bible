...
export default function SaladCreamHorseradishMarinadeStepper() {
  ...
  return (
    <div className="p-4 max-w-md mx-auto bg-white space-y-6 rounded-xl">
      ...
      <div className="flex justify-between text-sm font-medium text-gray-600">
        <div
          className={`flex-1 text-center py-2 border-b-2 ${step === 1 ? "border-black font-bold text-black" : "border-gray-300"
            }`}
        >
          Adjust
        </div>
        <div
          className={`flex-1 text-center py-2 border-b-2 ${step === 2 ? "border-black font-bold text-black" : "border-gray-300"
            }`}
        >
          Instructions
        </div>
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Whisk until combined.</p>
          <p><strong>How to Use:</strong> Great for beef steaks or pork tenderloin. Grill or pan-sear.</p>
