...
const baseSauce = {
  Mayonnaise: 80,
  "Nando’s peri-peri sauce (medium or hot)": 30,
  "Seafood or tartare sauce": 40,
  "Lemon juice": 10,
  Salt: 3,
};

export default function CreamyPeriPeriTartareStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> In a bowl, whisk together all ingredients until smooth. No cooking required.</p>
          <p><strong>How to Use:</strong> Serve as a dipping sauce for fish sticks or fried shrimp, or spread on a burger or sandwich for a spicy, creamy kick.</p>
          <p><strong>Flavor Profile:</strong> Creamy, spicy, and tangy with a seafood twist.</p>
