...
export default function WineGravyStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 1 && (
        <div className="space-y-4">
          ...
          <div className="flex justify-between pt-4 border-t text-sm font-medium text-gray-700">
            <span>Total: {totalWeight}g/ml</span>
            <button
              onClick={() => setStep(2)}
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>Total Quantity:</strong> {totalWeight}g/ml</p>
          <p><strong>How to Make:</strong> Dissolve gravy granules in hot water, then stir in cooking wine and butter. Stir until fully combined and smooth.</p>
          <p><strong>How to Use:</strong> Pour over roasted meats, mashed potatoes, or stuffing.</p>
          <p><strong>Flavor Profile:</strong> Rich, savory, and enhanced with wine depth.</p>
