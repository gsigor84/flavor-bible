...
const baseBlend = {
  ...
  turmeric: 1.25,
  garamMasala: 1.25,
  chiliPowder: 0.6, // optional, included by default
};

export default function MasalaBlend() {
  ...
  return (
    <div className="p-6 max-w-md mx-auto bg-white space-y-6">
      ...
      <div className="flex items-center justify-start">
        <h2 className="text-2xl font-bold">Masala Blend (Grams)</h2>
      </div>
        ...
        {Object.entries(blend).map(([ingredient, grams]) => (
          ...
          >
            <label className="w-24 capitalize text-gray-700">
              {ingredient.replace(/([A-Z])/g, " $1").toLowerCase()}:
            </label>
