...
const baseSauce = {
  "Sweet chilli sauce": 70,
  "Tomato ketchup": 50,
  "Soy sauce": 20,
  "Cooking vinegar (e.g., rice vinegar)": 10,
  "Sugar": 5,
};

export default function SweetChilliSoyGlazeStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Mix all ingredients in a small pan. Heat gently for 5 minutes, stirring until combined. Let cool slightly before serving.</p>
          <p><strong>How to Use:</strong> Use as a dipping sauce for spring rolls, chicken nuggets, or roasted vegetables, or drizzle over grilled meats.</p>
          <p><strong>Flavor Profile:</strong> Sweet, spicy, tangy, with a savory soy undertone.</p>
