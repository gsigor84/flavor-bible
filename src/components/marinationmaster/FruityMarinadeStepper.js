...
export default function FruityMarinadeStepper() {
    ...
    <div className="max-w-md mx-auto p-4 bg-white space-y-6 rounded-xl">
      ...
      {step === 2 && (
        <div className="space-y-4 text-sm text-gray-800">
          ...
          <p><strong>How to Make:</strong> Mix until smooth.</p>
          <p><strong>How to Use:</strong> Ideal for pork or chicken. Great for roasting or grilling.</p>
